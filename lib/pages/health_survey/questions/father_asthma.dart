...
class FatherAsthma extends StatelessWidget {
  FatherAsthma({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomCard(
      title: 'Has ${healthSurveyController.childName}\'s biological father ever been diagnosed or treated for asthma?',
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(5, 5, 5, 10),
        child: Obx(
          () => DropdownButton(
            dropdownColor: const Color.fromRGBO(15, 76, 117, 1),
            value: healthSurveyController.hasFatherAsthma.value,
            ...
            items: healthSurveyController.hasFatherAsthmaValues
                ...
                .toList(),
            onChanged: (value) {
              healthSurveyController.hasFatherAsthma.value = value as int;
            },
          ),
        ),
      ),

...
class AllergyTest extends StatelessWidget {
  AllergyTest({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomCard(
      title: 'Has ${healthSurveyController.childName} ever tested positive on an allergy test?',
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(5, 5, 5, 10),
        child: Obx(
          () => DropdownButton(
            dropdownColor: const Color.fromRGBO(15, 76, 117, 1),
            value: healthSurveyController.hasAllergyTest.value,
            ...
            items: healthSurveyController.hasAllergyTestValues
                ...
                .toList(),
            onChanged: (value) {
              healthSurveyController.hasAllergyTest.value = value as int;
            },
          ),
        ),
      ),

...
class MotherRace extends StatelessWidget {
  MotherRace({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomCard(
      title: 'What is ${healthSurveyController.childName}\'s biological mother\'s racial background?',
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(5, 5, 5, 10),
        child: Obx(
          () => DropdownButton(
            dropdownColor: const Color.fromRGBO(15, 76, 117, 1),
            value: healthSurveyController.motherRace.value,
            ...
            items: healthSurveyController.motherRaceValues
                ...
                .toList(),
            onChanged: (value) {
              healthSurveyController.motherRace.value = value as int;
            },
          ),
        ),
      ),

...
class MotherFoodAllergies extends StatelessWidget {
  MotherFoodAllergies({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomCard(
      title: 'Did ${healthSurveyController.childName}\'s biological mother have Food Allergies?',
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(5, 5, 5, 10),
        child: Obx(
          () => DropdownButton(
            dropdownColor: const Color.fromRGBO(15, 76, 117, 1),
            value: healthSurveyController.historyMotherFoodAllergies.value,
            ...
            items: healthSurveyController.historyMotherFoodAllergiesValues
                ...
                .toList(),
            onChanged: (value) {
              healthSurveyController.historyMotherFoodAllergies.value = value as int;
            },
          ),
        ),
      ),

...
class MotherAsthma extends StatelessWidget {
  MotherAsthma({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomCard(
      title: 'Has ${healthSurveyController.childName}\'s biological mother ever been diagnosed or treated for asthma?',
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(5, 5, 5, 10),
        child: Obx(
          () => DropdownButton(
            dropdownColor: const Color.fromRGBO(15, 76, 117, 1),
            value: healthSurveyController.hasMotherAsthma.value,
            ...
            items: healthSurveyController.hasMotherAsthmaValues
                ...
                .toList(),
            onChanged: (value) {
              healthSurveyController.hasMotherAsthma.value = value as int;
            },
          ),
        ),
      ),

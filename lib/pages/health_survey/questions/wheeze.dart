...
class Wheeze extends StatelessWidget {
  Wheeze({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomCard(
      title: 'From birth to age 3 years, did ${healthSurveyController.childName} ever wheeze?',
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(5, 5, 5, 10),
        child: Obx(
          () => DropdownButton(
            dropdownColor: const Color.fromRGBO(15, 76, 117, 1),
            value: healthSurveyController.hasWheeze.value,
            ...
            items: healthSurveyController.hasWheezeValues
                ...
                .toList(),
            onChanged: (value) {
              healthSurveyController.hasWheeze.value = value as int;
            },
          ),
        ),
      ),

...
class MotherEczema extends StatelessWidget {
  MotherEczema({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomCard(
      title: 'Did ${healthSurveyController.childName}\'s biological mother have Eczema/Atopic Dermatitis?',
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(5, 5, 5, 10),
        child: Obx(
          () => DropdownButton(
            dropdownColor: const Color.fromRGBO(15, 76, 117, 1),
            value: healthSurveyController.historyMotherEczemaDerm.value,
            ...
            items: healthSurveyController.historyMotherEczemaDermValues
                ...
                .toList(),
            onChanged: (value) {
              healthSurveyController.historyMotherEczemaDerm.value = value as int;
            },
          ),
        ),
      ),

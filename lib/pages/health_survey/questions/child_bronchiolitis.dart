...
class HistoryBronchiolitis extends StatelessWidget {
  HistoryBronchiolitis({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomCard(
      title: 'Has ${healthSurveyController.childName} ever been sick with Bronchiolitis?',
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(5, 5, 5, 10),
        child: Obx(
          () => DropdownButton(
            dropdownColor: const Color.fromRGBO(15, 76, 117, 1),
            value: healthSurveyController.historyChildBronchiolitis.value,
            ...
            items: healthSurveyController.historyChildBronchiolitisValues
                ...
                .toList(),
            onChanged: (value) {
              healthSurveyController.historyChildBronchiolitis.value = value as int;
            },
          ),
        ),
      ),

...
class FatherEnvAllergies extends StatelessWidget {
  FatherEnvAllergies({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomCard(
      title: 'Did ${healthSurveyController.childName}\'s biological father have Environmental Allergies?',
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(5, 5, 5, 10),
        child: Obx(
          () => DropdownButton(
            dropdownColor: const Color.fromRGBO(15, 76, 117, 1),
            value: healthSurveyController.historyFatherEnvAllergies.value,
            ...
            items: healthSurveyController.historyFatherEnvAllergiesValues
                ...
                .toList(),
            onChanged: (value) {
              healthSurveyController.historyFatherEnvAllergies.value = value as int;
            },
          ),
        ),
      ),

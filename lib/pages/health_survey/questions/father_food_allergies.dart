...
class FatherFoodAllergies extends StatelessWidget {
  FatherFoodAllergies({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomCard(
      title: 'Did ${healthSurveyController.childName}\'s biological father have Food Allergies?',
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(5, 5, 5, 10),
        child: Obx(
          () => DropdownButton(
            dropdownColor: const Color.fromRGBO(15, 76, 117, 1),
            value: healthSurveyController.historyFatherFoodAllergies.value,
            ...
            items: healthSurveyController.historyFatherFoodAllergiesValues
                ...
                .toList(),
            onChanged: (value) {
              healthSurveyController.historyFatherFoodAllergies.value = value as int;
            },
          ),
        ),
      ),
